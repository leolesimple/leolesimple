...
🚄 Passionné par le **web**, le **design** et les **projets liés aux transports**

---

### ⚙️ Compétences
- **Langages :** HTML, CSS (SCSS), JavaScript, TypeScript, PHP, SQL  
- **Frameworks / outils :** React, Next.js, TailwindCSS, Supabase  
- **Design :** Figma, Adobe XD, Illustrator, Photoshop  
- **Serveur :** Apache2, PHP, PM2, Fail2Ban  

---

### 🧠 En ce moment
- 💼 Je développe **InfoStation**, une plateforme dédiée à la mobilité francilienne  
- ☁️ Je construis mon **serveur personnel** pour héberger mes projets librement.
- 📚 Je développe une **datavisualisation** sur les affluences dans les gares à l'IUT.
